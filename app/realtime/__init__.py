...
class RealtimeAPI(RealtimeEventHandler):
    def __init__(
        ...
        if self.use_azure:
            ...
            self.user_agent = "openai-realtime-client"
            self.request_id = uuid.uuid4()
...
class RealtimeClient(RealtimeEventHandler):
    def __init__(self, url=None, api_key=None):
        ...
        self.default_session_config = {
            ...
            "turn_detection": {
                "type": "server_vad",
                "threshold": 0.3,  # Lower threshold for better voice detection
                "prefix_padding_ms": 500,  # More padding to catch speech start
                "silence_duration_ms": 800,  # Longer silence before processing
            },
            "tools": [],
            "tool_choice": "auto",
            "temperature": 0.7,
        ...
        self.default_server_vad_config = {
            ...
            "threshold": 0.3,  # Lower threshold for better voice detection
            "prefix_padding_ms": 500,  # More padding to catch speech start
            "silence_duration_ms": 800,  # Longer silence before processing (reduces cutoffs)
        }
